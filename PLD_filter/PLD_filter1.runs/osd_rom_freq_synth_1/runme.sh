...
HD_PWD='C:/Users/24238/Desktop/PLD/PLD_filter1/PLD_filter/PLD_filter.runs/osd_rom_freq_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log osd_rom_freq.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source osd_rom_freq.tcl
