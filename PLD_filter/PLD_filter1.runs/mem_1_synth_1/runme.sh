...
HD_PWD='C:/Users/24238/Desktop/PLD/PLD_filter1/PLD_filter/PLD_filter.runs/mem_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_1.tcl
