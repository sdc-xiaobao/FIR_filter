...
#
# Generated by export_simulation on Sat Nov 07 02:13:05 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './mem_1.sh' script.
...
./mem_1.sh -noclean_files

For more information on the script, please type './mem_1.sh -help'.
