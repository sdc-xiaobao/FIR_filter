...
#
# Generated by export_simulation on Sat Nov 07 02:14:56 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './mem_3.sh' script.
...
./mem_3.sh -noclean_files

For more information on the script, please type './mem_3.sh -help'.
