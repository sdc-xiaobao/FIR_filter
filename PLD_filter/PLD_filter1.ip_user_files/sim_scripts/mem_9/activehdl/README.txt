...
#
# Generated by export_simulation on Sat Nov 07 02:19:44 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './mem_9.sh' script.
...
./mem_9.sh -noclean_files

For more information on the script, please type './mem_9.sh -help'.
