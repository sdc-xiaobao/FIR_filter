...
#
# Generated by export_simulation on Sat Nov 07 02:15:42 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './mem_4.sh' script.
...
./mem_4.sh -noclean_files

For more information on the script, please type './mem_4.sh -help'.
