...
#
# Generated by export_simulation on Sat Nov 07 02:16:34 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './mem_5.sh' script.
...
./mem_5.sh -noclean_files

For more information on the script, please type './mem_5.sh -help'.
