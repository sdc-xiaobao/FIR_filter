...
#
# Generated by export_simulation on Sat Nov 07 02:17:20 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './mem_6.sh' script.
...
./mem_6.sh -noclean_files

For more information on the script, please type './mem_6.sh -help'.
