...
#
# Generated by export_simulation on Sat Nov 07 02:18:46 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './mem_8.sh' script.
...
./mem_8.sh -noclean_files

For more information on the script, please type './mem_8.sh -help'.
